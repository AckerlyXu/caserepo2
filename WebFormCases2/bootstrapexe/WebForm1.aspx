<%@ Page Title="" Language="C#" MasterPageFile="~/bootstrapexe/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="WebFormCases2.bootstrapexe.WebForm1" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>



<asp:content ContentPlaceHolderID="MainMaster" ID="MainMaster" runat="server">
...
.mydatagrid th
{
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <br />
            <asp:GridView ID="HSPolicyDocsDG" runat="server" CssClass="mydatagrid" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" RowStyle-CssClass="rows" AllowPaging="True" >
              <Columns>  
