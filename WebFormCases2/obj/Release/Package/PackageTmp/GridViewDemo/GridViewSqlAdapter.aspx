...
<body>
    <form id="form1" runat="server">
        <asp:GridView ID="GridView1" DataKeyNames="InfoId" runat="server" OnRowDataBound="GridView1_RowDataBound" AutoGenerateSelectButton="true" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnPageIndexChanging="GridView1_PageIndexChanging" OnPageIndexChanged="GridView1_PageIndexChanged">
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
